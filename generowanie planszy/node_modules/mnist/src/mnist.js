...
// size of the sample images (50 x 50)
var size = 50;

// raw data
var raw = [
  require('./images/0.json').data,
  require('./images/1.json').data,
  require('./images/2.json').data,
  require('./images/3.json').data,
  require('./images/4.json').data,
  require('./images/5.json').data,
  require('./images/6.json').data,
  require('./images/7.json').data,
  require('./images/8.json').data,
  require('./images/9.json').data
];
